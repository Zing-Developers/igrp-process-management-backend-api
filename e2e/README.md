...
`./email-access-mapping.sh` runs the whole flow on both apps (40 checks each: console, expiry, a full-catalogue mapping, paged and filtered listing, notes limit, idempotent revoke, duplicate session cookies).
